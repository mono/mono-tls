...
namespace Mono.Security.NewTls.EC
{
	public sealed class SecNamedCurves
	{
		...
		static readonly IDictionary<string,ASN1> objIds = new Dictionary<string,ASN1> ();
		static readonly IDictionary<ASN1,X9ECParametersHolder> curves = new Dictionary<ASN1,X9ECParametersHolder> ();
		static readonly IDictionary<ASN1,string> names = new Dictionary<ASN1,string> ();
		...
		{
			ASN1 oid = objIds [name.ToLower (CultureInfo.InvariantCulture)];
		 ...
		 */
		public static X9ECParameters GetByOid (ASN1 oid)
		{
		 ...
		 */
		public static ASN1 GetOid (string name)
		{
			return objIds [name.ToLower (CultureInfo.InvariantCulture)];
		}

		/**
		 * return the named curve name represented by the given object identifier.
		 */
		public static string GetName (ASN1 oid)
		{
			return names [oid];
		}
